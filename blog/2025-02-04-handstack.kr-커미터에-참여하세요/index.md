...
HandStack 프로젝트는 도메인 주도 로우코드 거버넌스를 위한 앱 개발 환경을 만들어 고객의 IT 과제를 해결하는 도구를 만듭니다. 프로젝트의 문서화 웹 사이트도 오픈소스로 제공되고 있으며, 이를 통해 더 많은 사람들이 프로젝트를 쉽게 이해하고 활용할 수 있도록 돕고자 합니다.

...
ack 프로그램이 실행되고 모듈 초기화를 실행하는 Url을 입력합니다. (기본값: http://localhost:8000/openapi/api/managed/initialize-settings)
...
> http://localhost:8000/openapi/module-settings.html

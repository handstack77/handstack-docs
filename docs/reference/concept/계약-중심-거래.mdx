...
> 실습으로 익히려면 학습 트랙의 [08. transact 거래 계약](/docs/tutorial/transact-거래계약/)을 참고하세요.
...
|commandType|명령구분|D: dbclient, G: graphclient, F: function, C: command, P: prompter, S: 순차 실행, W: 워크플로 등 명령 구분 ID|string|D||
...
|commandType|명령구분|D: dbclient, G: graphclient, F: function, C: command, P: prompter, S: 순차 실행, W: 워크플로 등 명령 구분 ID|string|request.Transaction.CommandType||

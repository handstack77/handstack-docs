...
> 실습으로 익히려면 학습 트랙의 [05. 화면 저작](/docs/tutorial/화면저작/), [08. transact 거래 계약](/docs/tutorial/transact-거래계약/)을 참고하세요.
...
|JsonObject|Form, Grid, Chart, DataSet, Dynamic, Addition 형식의 JSON 포맷|O|
|JsonObjects|Form, Grid, Chart, DataSet, Dynamic, Addition 형식의 JSON 포맷 배열|O|

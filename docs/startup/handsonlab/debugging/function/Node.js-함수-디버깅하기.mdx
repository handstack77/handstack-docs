...
```
코드) handstack\2.Modules\wwwroot\Contracts\wwwroot\HDS\TST\JSF010.html
...
```
코드) handstack\2.Modules\wwwroot\Contracts\wwwroot\HDS\TST\JSF010.js
...
```
코드) handstack\2.Modules\function\Contracts\function\HDS\TST\JSF010\featureMain.js
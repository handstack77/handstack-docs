...
> **MSSQL, Oracle, MariaDB, PostgreSQL 데이터베이스**에 서버 시간과 서버명을 조회하는 거래 테스트에 필요한 환경을 구성하려면 [docker 기반 개발용 데이터베이스 설치하기](https://handstack.kr/docs/startup/handsonlab/docker-%EA%B8%B0%EB%B0%98-%EA%B0%9C%EB%B0%9C%EC%9A%A9-%EB%8D%B0%EC%9D%B4%ED%84%B0%EB%B2%A0%EC%9D%B4%EC%8A%A4-%EC%84%A4%EC%B9%98%ED%95%98%EA%B8%B0) 문서를 참고하세요.

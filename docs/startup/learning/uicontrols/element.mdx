...
`/uicontrols/Element/example/` 경로의 예제를 아래 iframe에서 바로 확인할 수 있습니다.

### basic.html

<iframe
  src="/uicontrols/Element/example/basic.html"
  width="100%"
  height="640"
  style={{ border: '1px solid #ccc', borderRadius: '8px' }}
  title="Element basic 실전 예제"
  allow="fullscreen">
</iframe>
...
|---|---|
| 컨트롤 | `Element` |
| 전역 별칭 | `syn.uicontrols.$element` |
| 버전 | `v2025.12.25` |
| 소스 | `uicontrols/Element/Element.js` |

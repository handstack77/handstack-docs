...
> 공통 assets 디렉토리는 `C:\home\[사용자 ID]\handstack\modules\wwwroot\wwwroot` 입니다. 여기에 있는 모든 파일은 웹 브라우저에 다음과 같이 루트 경로로 공개됩니다. /module.html, /js/syn.js 등등
...
이렇게 파일을 관리하면 웹 브라우저에서 다음과 같이 실행합니다. [http://localhost:8000/view/HDS/TST/TST010.html](http://localhost:8000/view/HDS/TST/TST010.html)

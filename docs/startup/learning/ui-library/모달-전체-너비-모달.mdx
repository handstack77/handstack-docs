...
## 사용된 주요 클래스
`btn`, `btn-close`, `btn-primary`, `fade`, `me-auto`, `modal`, `modal-blur`, `modal-body`, `modal-content`, `modal-dialog`, `modal-dialog-centered`, `modal-footer`, `modal-full-width`, `modal-header`, `modal-title`

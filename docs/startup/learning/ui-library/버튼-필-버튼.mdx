...
필 버튼을 사용하려면 .btn-pill 클래스를 사용하세요.
...
## 사용된 주요 클래스
`align-items-center`, `bg-dark`, `btn`, `btn-danger`, `btn-dark`, `btn-info`, `btn-light`, `btn-pill`, `btn-primary`, `btn-secondary`, `btn-success`, `btn-warning`, `col-12`, `col-6`, `col-md-2`, `col-sm-4`, `col-xl`, `col-xl-2`, `font-weight-semibold`, `g-2`, `py-3`, `row`, `w-100`

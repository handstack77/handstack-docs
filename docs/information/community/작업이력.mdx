...
```txt
"HDS|ZZW|D|T": "http://localhost:8080/dbclient/api/query",
"HDS|ZZW|D|D": "event://dbclient.Events.DbClientRequest",
"HDS|ZZW|F|D": "http://localhost:8080/function/api/execution",
"HDS|ZZW|R|D": "http://localhost:8080/repository/api/request",
"HDS|ZZD|D|T": "http://localhost:8080/dbclient/api/query",
...
"Definition": {
    ...
    "Controls": [
        ...
        "/uicontrols/TextButton/TextButton.js",

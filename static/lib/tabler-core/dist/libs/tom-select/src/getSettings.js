...
var defaults_ts_1 = require("./defaults.ts");
...
function getSettings(input, settings_user) {
    ...
    var init_select = function () {
        ...
        var addGroup = function (optgroup) {
            ...
            (0, utils_ts_1.iterate)(optgroup.children, function (option) {
                addOption(option, id);
            });
        };
        settings_element.maxItems = input.hasAttribute('multiple') ? null : 1;
        (0, utils_ts_1.iterate)(input.children, function (child) {
    ...
    var init_textbox = function () {
        ...
        if (!data_raw) {
            ...
            (0, utils_ts_1.iterate)(values, function (value) {
                var option = {};
            ...
            (0, utils_ts_1.iterate)(settings_element.options, function (opt) {

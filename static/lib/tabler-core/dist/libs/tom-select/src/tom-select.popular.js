...
var plugin_ts_1 = require("./plugins/caret_position/plugin.ts");
var plugin_ts_2 = require("./plugins/dropdown_input/plugin.ts");
var plugin_ts_3 = require("./plugins/no_backspace_delete/plugin.ts");
var plugin_ts_4 = require("./plugins/remove_button/plugin.ts");
var plugin_ts_5 = require("./plugins/restore_on_backspace/plugin.ts");

...
var tom_select_ts_1 = require("./tom-select.ts");
var plugin_ts_1 = require("./plugins/change_listener/plugin.ts");
var plugin_ts_2 = require("./plugins/checkbox_options/plugin.ts");
var plugin_ts_3 = require("./plugins/clear_button/plugin.ts");
var plugin_ts_4 = require("./plugins/drag_drop/plugin.ts");
var plugin_ts_5 = require("./plugins/dropdown_header/plugin.ts");
var plugin_ts_6 = require("./plugins/caret_position/plugin.ts");
var plugin_ts_7 = require("./plugins/dropdown_input/plugin.ts");
var plugin_ts_8 = require("./plugins/input_autogrow/plugin.ts");
var plugin_ts_9 = require("./plugins/no_backspace_delete/plugin.ts");
var plugin_ts_10 = require("./plugins/no_active_items/plugin.ts");
var plugin_ts_11 = require("./plugins/optgroup_columns/plugin.ts");
var plugin_ts_12 = require("./plugins/remove_button/plugin.ts");
var plugin_ts_13 = require("./plugins/restore_on_backspace/plugin.ts");
var plugin_ts_14 = require("./plugins/virtual_scroll/plugin.ts");

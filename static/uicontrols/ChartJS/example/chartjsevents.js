...
let $chartjsevents = {
    ...
    event: {
        ...
        chtTrend_pointClick(elID, params, selections) {
            syn.$l.eventLog('chtTrend_pointClick', JSON.stringify(params.selection));
        },

        chtTrend_selectionChange(elID, params, selections) {
            syn.$l.get('preLog').textContent = JSON.stringify(selections, null, 2);
        },

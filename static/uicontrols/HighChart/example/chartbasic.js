...
let $chartbasic = {
    prop: {
        rows: [
            { YEAR: '2023', AMOUNT: 120, PROFIT: 22 },
            { YEAR: '2024', AMOUNT: 155, PROFIT: 35 },
            { YEAR: '2025', AMOUNT: 182, PROFIT: 48 },
            { YEAR: '2026', AMOUNT: 210, PROFIT: 61 }
        ],
        metaColumns: {
            YEAR: { FieldID: 'YEAR', DataType: 'string' },
            AMOUNT: { FieldID: 'AMOUNT', DataType: 'number' },

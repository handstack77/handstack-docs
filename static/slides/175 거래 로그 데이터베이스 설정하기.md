...
| ApplicationID | nvarchar | 32 | YES | 애플리케이션 고유 ID |
...
| ProjectID | nvarchar | 32 | YES | 프로젝트 고유 ID |
...
| ServiceID | nvarchar | 32 | YES | 서비스 고유 ID |
| TransactionID | nvarchar | 32 | YES | 트랜잭션 고유 ID |
| Type | nvarchar | 1 | YES | 로그 유형 |
| UserID | nvarchar | 32 | YES | 사용자 고유 ID |
| CreatedAt | datetime2 | -1 | YES | 로그 생성 시간 |
| IpAddress | varchar | 50 | YES | 요청자 IP 주소 |
| DeviceID | varchar | 64 | YES | 단말 고유 ID |
| ProgramID | varchar | 50 | YES | 프로그램 고유 ID |

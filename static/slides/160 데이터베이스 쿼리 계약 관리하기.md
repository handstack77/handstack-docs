...
암호화된 문자열은 `ConnectionString`에 넣고 `IsEncryption` 값을 `"Y"`로 변경하여 사용합니다.
...
[DbType 열거형 참조](https://learn.microsoft.com/ko-kr/dotnet/api/system.data.dbtype?view=net-10.0)
...
- MySqlDbType: https://dev.mysql.com/doc/dev/connector-net/10.0/api/data_api/MySql.Data.MySqlClient.MySqlDbType.html
